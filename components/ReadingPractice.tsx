      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 lg:w-1/2">
          <div className="bg-blue-50 p-6 or p-8 rounded-2xl border border-blue-100 shadow-inner h-full">
            ...
            <div className="space-y-4 text-[var(--text)] text-justify leading-loose">
        ...
        {/* Cột phải: Câu hỏi */}
        <div className="flex-1 lg:w-1/2 flex flex-col gap-6 max-h-[80vh] overflow-y-auto pr-2 custom-scrollbar">
          {submitted && (
